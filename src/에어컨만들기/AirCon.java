...
public class AirCon {
   ...
   private int windStep;       // 1단, 2단, 3단
    ...
    void airConInfo(){
        ...
        String heaterStr = (isHeater && !isCooler) ? "ON" : "OFF";
        String coolerStr = (isCooler && !isHeater) ? "ON" : "OFF";
    ...
    public void setCurrTemp(int n){ // 매개 변수의 정수값을 받아 현재 온도를 변경
        currTemp += n;
    }
    public int getCurrTemp(){   // 현재 온도를 읽는 멧소드
        return currTemp;
    }
