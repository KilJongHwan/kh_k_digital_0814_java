...
//        System.out.printf("%.2f\n",pi);
        ...
        // 서식 지정자 : %d(정수), %ld(long 타입 정수), %u(보호 없는 정수형), %f(실수형), %c(문자형)
        // escape sequence : \n(줄바꿈), \r(carriage return, 커서를 라인의 처음으로 이동), \t(탭),\b(백스페이스), \\
        System.out.println("==========C Language Style===========");
        System.out.printf("이름 : %s\n", name);
        System.out.printf("오늘의 습도는 %.2f%% 입니다.\n", 85.55555555);    // 실수형 출력, 소수점이하 2자리까지
