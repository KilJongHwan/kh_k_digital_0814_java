...
public class StreamMainFinalEx {
    public static void main(String[] args) {
        TravelCustomer customerA = new TravelCustomer("James", 21 ,100);
        TravelCustomer customerB = new TravelCustomer("Kane", 23 ,100);
        TravelCustomer customerC = new TravelCustomer("Jessy", 25 ,80);
        List<TravelCustomer> customerList = new ArrayList<>();
        customerList.add(customerA);
        customerList.add(customerB);
        customerList.add(customerC);
        customerList.add(new TravelCustomer("samuel",18, 90));
